...
収録数は **182件** です。日付は git 履歴（そのファイルが追加されたコミット）によります。

| 追加日 | 件数 | 追加したアイコン | 内容 |
|---|---:|---|---|
| 2026-08-15 | 7 | <img src="icons/dm-toyonaka-2225.svg" width="22" height="22" title="塗りつぶしの長円（名称未確認）"> <img src="icons/dm-toyonaka-2248.svg" width="22" height="22" title="丸に「案」（名称未確認）"> <img src="icons/dm-toyonaka-4133.svg" width="22" height="22" title="丸に横線7本（名称未確認）"> <img src="icons/dm-toyonaka-4134.svg" width="22" height="22" title="丸に横線4本・上半分（名称未確認）"> <img src="icons/dm-toyonaka-4144.svg" width="22" height="22" title="丸に横線4本・下半分（名称未確認）"> <img src="icons/dm-toyonaka-4145.svg" width="22" height="22" title="丸に横線5本・下半分（名称未確認）"> <img src="icons/dm-toyonaka-4214.svg" width="22" height="22" title="三角形の旗（名称未確認）"> | feat: 豊中市の拡張DMコード7件のアイコンを追加する |
| 2026-08-15 | 8 | <img src="icons/dm-2241.svg" width="22" height="22" title="道路情報板"> <img src="icons/dm-2247.svg" width="22" height="22" title="信号灯専用ポールのないもの"> <img src="icons/dm-2251.svg" width="22" height="22" title="交通量観測所"> <img src="icons/dm-2252.svg" width="22" height="22" title="スノーポール"> <img src="icons/dm-2255.svg" width="22" height="22" title="距離標（km）"> <img src="icons/dm-2256.svg" width="22" height="22" title="距離標（m）"> <img src="icons/dm-2263.svg" width="22" height="22" title="火災報知器"> <img src="icons/dm-2419.svg" width="22" height="22" title="鉄道のトンネル"> | feat: 交通施設（レイヤ22・24）の未作成アイコン8件を追加する |
